...
- Run `$ pnpm install` installs dependencies for the extension and the server.
- Run `$ pnpm run watch` to compile and re-compile the client and server in the background on each change.
