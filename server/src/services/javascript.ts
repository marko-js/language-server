...
export function getLanguageHost(rootFileNames: string[]): ts.LanguageServiceHost {
...
export function updateCurrentMarkoTextDocument(options:IAutocompleteArguments) {
    const {
        doc,
        // scopeAtPos,
