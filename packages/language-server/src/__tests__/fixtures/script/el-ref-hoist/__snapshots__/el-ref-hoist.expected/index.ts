...
(function (this: void) {
  ...
  const { $hoistedEl, $el } = Marko._.hoist(() => __marko_internal_hoists);
  const __marko_internal_tag_1 = Marko._.resolveTemplate(
    import("@marko/runtime-tags/tags/const.d.marko"),
  );
  var __marko_internal_rendered_1 = Marko._.renderTemplate(
  ...
  });
  {
    ...
    var __marko_internal_rendered_2 = Marko._.renderNativeTag("div")()()({
      /*div*/
    });
    {
  ...
  const __marko_internal_hoists = { $hoistedEl, $el };
