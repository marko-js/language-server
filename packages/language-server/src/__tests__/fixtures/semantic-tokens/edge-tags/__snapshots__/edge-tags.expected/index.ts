...
(function (this: void) {
  ...
  const tag = Marko._.hoist(() => __marko_internal_hoist__tag);
  const __marko_internal_tag_1 = Marko._.resolveTemplate(
    import("@marko/runtime-tags/tags/let.d.marko"),
  );
  {
    const tag = Marko._.returned(() => __marko_internal_rendered_1);
    const __marko_internal_rendered_1 = Marko._.renderTemplate(
      __marko_internal_tag_1,
    )()()({
      value: "section",
    });
    const __marko_internal_tag_2 = tag;
    ...
    var __marko_internal_hoist__tag = tag;
  }
  Marko._.noop({ tag, input, $global, $signal });
  return;
})();
