import B from "./components/A.marko";
import Bc from "./components/Ab.marko";
...
(function (this: void) {
  ...
  const __marko_internal_tag_6 = Marko._.interpolated`I`;
