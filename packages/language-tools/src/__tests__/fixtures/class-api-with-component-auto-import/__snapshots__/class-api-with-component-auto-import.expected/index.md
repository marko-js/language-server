...
```marko
> 1 | <div onClick("handleClickMissing")/>
    |      ^^^^^^^ Type '((...args: any) => any) | ((eventName: PropertyKey, ...args: any[]) => boolean) | (() => void) | { <Key extends PropertyKey>(name: never, value: (Record<PropertyKey, any> & Record<...>)[Key]): void; (value: Partial<...>): void; } | (<Key extends PropertyKey>(name: never, value?: (Record<...> & Record<...>)[Key] | un...' is not assignable to type '((event: MouseEvent, element: HTMLDivElement) => void) | undefined'.
