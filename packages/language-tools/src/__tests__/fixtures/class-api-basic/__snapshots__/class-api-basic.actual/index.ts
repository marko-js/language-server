import fancyButton from "/Users/dpiercey/dev/marko-js/language-server/packages/language-tools/src/__tests__/fixtures/class-api-basic/components/fancy-button/index.marko";
