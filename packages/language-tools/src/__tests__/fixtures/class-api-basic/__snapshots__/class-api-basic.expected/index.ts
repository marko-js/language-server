...
export default 1 as unknown as Marko.Template<"@language-tools/src/__tests__/fixtures/class-api-basic/index.marko">;
declare global {
  namespace Marko {
    interface CustomTags {
      "@language-tools/src/__tests__/fixtures/class-api-basic/index.marko": CustomTag<
        Input,
        ReturnType<typeof ˍ>,
        ட
      >;
