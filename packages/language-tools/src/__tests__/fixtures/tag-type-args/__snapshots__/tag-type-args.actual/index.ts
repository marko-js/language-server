...
declare namespace ˍ {
  ...
  const tags: {
    "test-tag": Marko.ட.CustomTagRenderer<
      typeof import("/Users/dpiercey/dev/marko-js/language-server/packages/language-tools/src/__tests__/fixtures/tag-type-args/components/test-tag.marko").default
    >;
  };
}
