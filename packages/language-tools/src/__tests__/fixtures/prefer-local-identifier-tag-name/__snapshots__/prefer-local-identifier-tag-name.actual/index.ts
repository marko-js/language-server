import CustomTagA from "/Users/dpiercey/dev/marko-js/language-server/packages/language-tools/src/__tests__/fixtures/prefer-local-identifier-tag-name/components/TestTagA.marko";
import CustomTagB from "/Users/dpiercey/dev/marko-js/language-server/packages/language-tools/src/__tests__/fixtures/prefer-local-identifier-tag-name/components/TestTagB.marko";
...
declare namespace ˍ {
  ...
  const tags: {
    ...
    TestTagA: Marko.ட.CustomTagRenderer<
      typeof import("/Users/dpiercey/dev/marko-js/language-server/packages/language-tools/src/__tests__/fixtures/prefer-local-identifier-tag-name/components/TestTagA.marko").default
    >;
    TestTagB: Marko.ட.CustomTagRenderer<
      typeof import("/Users/dpiercey/dev/marko-js/language-server/packages/language-tools/src/__tests__/fixtures/prefer-local-identifier-tag-name/components/TestTagB.marko").default
    >;
